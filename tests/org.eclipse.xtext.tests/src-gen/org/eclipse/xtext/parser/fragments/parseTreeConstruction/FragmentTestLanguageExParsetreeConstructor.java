...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ParserRuleFragmentsEx_ParserRuleFragmentsParserRuleCall(this, this, 0, inst);
			case 1: return new ParserRuleFragments_Group(this, this, 1, inst);
			case 2: return new PRFNamed_Group(this, this, 2, inst);
			case 3: return new PRFNamedRefFirst_Group(this, this, 3, inst);
			case 4: return new PRFNamedWithAction_Group(this, this, 4, inst);
			case 5: return new PRFNamedWithActionInFragment_Group(this, this, 5, inst);
			case 6: return new PRFNamedWithActionInFragment2_Group(this, this, 6, inst);
			case 7: return new PRFNamedWithActionInFragment3_Group(this, this, 7, inst);
			case 8: return new PRFNamedWithFQN_Group(this, this, 8, inst);
			default: return null;
		}	
	}	
}
...
/************ begin Rule ParserRuleFragmentsEx ****************
 *
...
// ParserRuleFragments
protected class ParserRuleFragmentsEx_ParserRuleFragmentsParserRuleCall extends RuleCallToken {
	
	public ParserRuleFragmentsEx_ParserRuleFragmentsParserRuleCall(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getParserRuleFragmentsExAccess().getParserRuleFragmentsParserRuleCall();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getParserRuleFragmentsAccess().getParserRuleFragmentsAction_0().getType().getClassifier())
			return null;
		if(checkForRecursion(ParserRuleFragments_Group.class, eObjectConsumer)) return null;
...
/************ end Rule ParserRuleFragmentsEx ****************/
