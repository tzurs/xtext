...
public class XtextGrammarTestLanguageSemanticSequencer extends AbstractDelegatingSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == XtextTestPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case XtextTestPackage.CONDITIONAL_BRANCH:
				if(context == grammarAccess.getAbstractTokenRule() ||
				   ...
				   context == grammarAccess.getUnorderedGroupRule() ||
				   context == grammarAccess.getUnorderedGroupAccess().getUnorderedGroupElementsAction_1_0()) {
					sequence_AbstractTokenWithCardinality_ConditionalBranch(context, (ConditionalBranch) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getAbstractTerminalRule() ||
				   context == grammarAccess.getAlternativesRule() ||
			...
			case XtextTestPackage.EOF:
				if(context == grammarAccess.getEOFRule() ||
				   context == grammarAccess.getTerminalTokenElementRule()) {
				   ...
				   context == grammarAccess.getTerminalGroupAccess().getGroupElementsAction_1_0() ||
				   context == grammarAccess.getTerminalTokenRule()) {
					sequence_TerminalToken(context, (EOF) semanticObject); 
					return; 
				}
				else break;
			...
			case XtextTestPackage.GROUP:
				if(context == grammarAccess.getAbstractTokenRule() ||
				   context == grammarAccess.getAbstractTokenWithCardinalityRule() ||
				   context == grammarAccess.getGroupAccess().getGroupElementsAction_1_0()) {
					sequence_AbstractTerminal_AbstractTokenWithCardinality_Group_PredicatedGroup(context, (Group) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getAbstractTerminalRule()) {
					sequence_AbstractTerminal_Group_PredicatedGroup(context, (Group) semanticObject); 
					return; 
				}
				   ...
				   context == grammarAccess.getUnorderedGroupRule() ||
				   context == grammarAccess.getUnorderedGroupAccess().getUnorderedGroupElementsAction_1_0()) {
					sequence_AbstractTokenWithCardinality_Group_PredicatedGroup(context, (Group) semanticObject); 
					return; 
				}
			...
			case XtextTestPackage.KEYWORD:
				if(context == grammarAccess.getAbstractTokenRule() ||
				   ...
				   context == grammarAccess.getUnorderedGroupRule() ||
				   context == grammarAccess.getUnorderedGroupAccess().getUnorderedGroupElementsAction_1_0()) {
					sequence_AbstractTerminal_AbstractTokenWithCardinality_Keyword_PredicatedKeyword(context, (Keyword) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getAbstractTerminalRule()) {
					sequence_AbstractTerminal_Keyword_PredicatedKeyword(context, (Keyword) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getAssignableAlternativesRule() ||
				   context == grammarAccess.getAssignableAlternativesAccess().getAlternativesElementsAction_1_0() ||
			...
			case XtextTestPackage.RULE_CALL:
				if(context == grammarAccess.getAbstractTokenRule() ||
				   ...
				   context == grammarAccess.getUnorderedGroupRule() ||
				   context == grammarAccess.getUnorderedGroupAccess().getUnorderedGroupElementsAction_1_0()) {
					sequence_AbstractTerminal_AbstractTokenWithCardinality_PredicatedRuleCall_RuleCall(context, (RuleCall) semanticObject); 
					return; 
				}
				else if(context == grammarAccess.getAbstractTerminalRule()) {
					sequence_AbstractTerminal_PredicatedRuleCall_RuleCall(context, (RuleCall) semanticObject); 
					return; 
				}
	 ...
	 *     )
	 */
	protected void sequence_AbstractTerminal_AbstractTokenWithCardinality_Group_PredicatedGroup(EObject context, Group semanticObject) {
	 ...
	 */
	protected void sequence_AbstractTerminal_AbstractTokenWithCardinality_Keyword_PredicatedKeyword(EObject context, Keyword semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_AbstractTerminal_AbstractTokenWithCardinality_PredicatedRuleCall_RuleCall(EObject context, RuleCall semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     ((elements+=Group_Group_1_0 elements+=AbstractToken+) | ((predicated?='=>' | firstSetPredicated?='->') elements+=Alternatives))
	 */
	protected void sequence_AbstractTerminal_Group_PredicatedGroup(EObject context, Group semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_AbstractTerminal_Keyword_PredicatedKeyword(EObject context, Keyword semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_AbstractTerminal_PredicatedRuleCall_RuleCall(EObject context, RuleCall semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     )
	 */
	protected void sequence_AbstractTokenWithCardinality_Group_PredicatedGroup(EObject context, Group semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_AbstractTokenWithCardinality_UnorderedGroup(EObject context, UnorderedGroup semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_PredicatedGroup(EObject context, Group semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_PredicatedKeyword(EObject context, Keyword semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     ((predicated?='=>' | firstSetPredicated?='->') rule=[AbstractRule|ID])
	 */
	protected void sequence_PredicatedRuleCall(EObject context, RuleCall semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_TerminalRuleCall_TerminalToken(EObject context, RuleCall semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     ((cardinality='?' | cardinality='*' | cardinality='+')?)
	 */
	protected void sequence_TerminalToken(EObject context, EOF semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
